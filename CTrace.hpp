...
{
public:
	bool PointsOutOfWorld(Vector& const ptr)
	{
		typedef bool(__thiscall* GetPointsOowFn)(PVOID, Vector& const);
		return getvfunc<GetPointsOowFn>(this, 16)(this, ptr);
	}
	void GetPointContents(Vector& const ptr, int* handle)
	{
		typedef void(__thiscall* GetPointsFn)(PVOID, Vector& const, int*);
		return getvfunc<GetPointsFn>(this, 0)(this, ptr, handle);
	}
	void TraceRay(const Ray_t& ray, unsigned int fMask, ITraceFilter* pTraceFilter, CGameTrace* pTrace)//5
	{
